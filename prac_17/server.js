...
// ========== VAPID КЛЮЧИ ==========
// Для генерации своих ключей выполните: npx web-push generate-vapid-keys
// Эти ключи демонстрационные - замените на свои!
const vapidKeys = {
    publicKey: 'BCgC3NNTvM7ew5VfeqIH6TIV9WdY7q7SLNfpMBujXyLyogv6msapFaQHAufL8Ra6pvDAFuGgW-7ayUIT2ygA0uk',
    privateKey: 'w1btIw00EP_exwmpJwSfrU-k2_npEDQEosV1Lo5aJDQ'
};
